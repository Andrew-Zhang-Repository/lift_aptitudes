      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-gray-200 dark:border-neutral-700 p-8">
          ...
          <p className="text-gray-500 dark:text-neutral-400 mb-8">
            {isGuest
              ? "Compare your lift stats against strength standards. Sign up to save your results. Logged in users get seamless muscle mapping highlights due to caching and personal tracking"
